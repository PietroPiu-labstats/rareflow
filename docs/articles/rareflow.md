...
Rare events are outcomes that occur with extremely small probability but
often carry significant scientific or practical importance. Examples
include:

- transitions between metastable states in stochastic differential
  equations (SDEs),
...
The package offers modular flow models, variational optimization, and
specialized wrappers for rare-event tilting.
...
![](rareflow_files/figure-html/unnamed-chunk-6-1.png)

The quasi-potential between two points $`a`$ and $`b`$ is defined as the
minimum action over all admissible paths connecting them:
...
![](rareflow_files/figure-html/unnamed-chunk-8-1.png)
...
![](rareflow_files/figure-html/unnamed-chunk-9-1.png) We simulate a 2D
diffusion:
...
![](rareflow_files/figure-html/unnamed-chunk-10-1.png)
...
![](rareflow_files/figure-html/unnamed-chunk-11-1.png)
...
We animate the 2D trajectory simulated in the radial double-well
potential.
...
- Oksendal, B. (2003). *Stochastic Differential Equations: An
